...
class Window:
    ...
    def timer(self):
        ...
        for grey_ball in self.marbles[14]:
            if grey_ball != 7:
                print('Game Over')
    ...
    def pause_window(self,mainwindow):
        ...
        def user_name():
            ...
            label = tk.Label(toplevel, text="Enter username in Upper case:",font="verdana 12 bold", bg='#047E97')
...
class FiringMarble:
    ...
    def touched_or_mantinel(self):
        ...
        # check whether I hit right or left boundry
        if self.x - 21 < 0 or self.x + 21 >= Window.playground_width:
            self.dx *= -1  # change direction in x axis
        elif self.y - 21 < 0:  # Am I at the top boundry??? Then stop!
            return True
    ...
    def detect_cell(self):
        ...
        if row % 2 == 0:  # starts on the left boundry
    ...
    def middle_of_cell(coords):
        ...
        if row % 2 == 0:  # starts on the left bounfry
            x = Window.border_width + 40 * column + 20
        else:  # starts 20 pixel away from the right boundry
    ...
    def marble_in_my_way(self):
        ...
        # I am at the top mantinel
            ...
            # print("I am at the top boundry")
            self.where_to_fall = (self.row, self.column)
            return True

        # I am somewhere inside
        elif self.row % 2 == 0:  # starts on the left boundry
            # print("row % 2 = 0")
    ...
    def find_disconnected_marbles(self):
        """
        finds marbles that are not connected to to top boundry and are alone
