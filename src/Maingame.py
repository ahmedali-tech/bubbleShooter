...
import winsound
import pickle
from Help_window import help_win
from game import Game
from game_window_components import *

#------------FUNCTIONS LEADING TO NEW WINDOWS--------------------
def music():
    winsound.PlaySound("faded.wav", winsound.SND_ASYNC|winsound.SND_LOOP)
def new_game_but():
    help_win()
...
def load_game_but():
    ...
    leader_window.title("BUBBLE SHOOTER--LOAD GAME")
    ...
    leader_window.iconphoto(False, p1)
...
new_game_button_image=tk.PhotoImage(file="../images/pic.png")
new_game_button_image=new_game_button_image.subsample(5,5)
...
new_game_button=tk.Button(but_frame,image=new_game_button_image,font="comicsans 20 bold",bg="#ED2C5C",height=70,width=150,command=new_game_but)
